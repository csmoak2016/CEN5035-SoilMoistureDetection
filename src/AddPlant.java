...
//  }
   ...
   * Create the dialog.
   */
  public LinkedList<Plant> AddPlant(LinkedList<Plant> plants) {
    setTitle("Add Plant");
      ...
      getContentPane().add(buttonPane, BorderLayout.SOUTH);
      {
        ...
        okButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String plantType = textField_1.getText();
                int waterInterval = Integer.parseInt(textField_2.getText());
                Plant plant = new Plant(name, plantType, waterInterval);
                plants.add(plant);
